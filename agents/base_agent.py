    ...
    def decide_action(
        ...
        try:
            ...
            if isinstance(game_state, dict):
                ...
                self.logger.error("Received None game state")
                return "fold"  # Changed to return fold for None game state
            else:
    ...
    def perceive(
        ...
        try:
            ...
            if isinstance(game_state, dict):
                ...
                perception = {
                    "game_state": {},  # Changed to empty dict for None
                    "opponent_message": opponent_message,
                    "timestamp": time.time(),
                    "error": "Received None game state",
                }
            else:
